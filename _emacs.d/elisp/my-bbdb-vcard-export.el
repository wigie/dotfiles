...
(defun bbdb-vcard-export-record-insert-vcard (record)
  ...
  (let ((name (bbdb-record-name record))
    ...
    (bday (bbdb-record-getprop record 'birthday))
    (ann (bbdb-record-getprop record 'anniversary))
    (children (bbdb-record-getprop record 'children)))
    ...
    (when timestamp
      (insert "rev:" (bbdb-vcard-export-escape timestamp) "\n"))
    (when web
      (insert "url:" (bbdb-vcard-export-escape web) "\n"))
    (when (or notes children)
      (insert "note:"
              (bbdb-vcard-export-escape notes)
              (if children 
                (concat "\\nChildren: "
                        (bbdb-vcard-export-escape children))
                "")
              "\n"))
